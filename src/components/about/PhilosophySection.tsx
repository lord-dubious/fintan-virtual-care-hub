...
const PhilosophySection = () => {
  return (
    <div className="mb-8">
      <h3 className="text-xl font-semibold mb-4 dark:text-medical-dark-text-primary">What to expect from a virtual consultation with Dr. Fintan</h3>
      <div className="bg-gray-50 dark:bg-gray-800 p-5 rounded-md border-l-4 border-medical-primary dark:border-medical-accent">
        <p className="italic text-medical-neutral-600 dark:text-medical-dark-text-secondary mb-4">
          "Dr Fintan's medical practice is an amalgamation of Orthodox and Alternative medicine, yielding a blend of 
