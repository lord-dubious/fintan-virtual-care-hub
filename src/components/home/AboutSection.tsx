...
const AboutSection: React.FC = () => {
  ...
  return (
    <section className="py-16 bg-medical-bg-light">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-5/12">
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-6 -right-6 bg-white p-5 rounded-lg shadow-lg z-20 border-l-4 border-medical-primary">
                <div className="flex items-center">
                  <Award className="h-8 w-8 text-medical-primary mr-3" />
                  <div>
                    <p className="text-medical-neutral-600 font-bold">15+ Years</p>
                    <p className="text-medical-neutral-400 text-sm">Medical Experience</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:w-7/12">
            <span className="text-medical-primary font-medium">About Dr. Fintan</span>
            <h2 className="text-3xl font-bold mt-2 mb-4">Dedicated to Accessible Healthcare Through Technology</h2>
            <p className="text-medical-neutral-500 mb-6 leading-relaxed">
            ...
            <p className="text-medical-neutral-500 mb-8 leading-relaxed">
            ...
            <div className="mb-8">
              <h4 className="text-lg font-semibold mb-3 text-medical-neutral-600">Qualifications & Expertise</h4>
              <ul className="space-y-2">
                {qualifications.map((item, index) => (
                  <li key={index} className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-medical-secondary mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-medical-neutral-500">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
