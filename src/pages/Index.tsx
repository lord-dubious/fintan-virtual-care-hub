  ...
  const specialties = [
    {
      icon: Brain,
      title: "Neurology",
      description: "Expert neurological assessment and care"
    },
    {
      icon: Heart,
        ...
        <section className={`${isMobile ? 'py-8' : 'py-16 md:py-24'}`}>
          <div className={`${isMobile ? '' : 'container mx-auto px-4'}`}>
            <div className="max-w-7xl mx-auto">
                    ...
                    <div className={`${isMobile ? 'order-2 p-6' : 'lg:col-span-3 p-8 lg:p-12'} flex flex-col justify-center bg-gradient-to-r from-white to-blue-50 dark:from-gray-800 dark:to-blue-900/20`}>
                      ...
                      <div className="space-y-4 mb-8">
                        ...
                        <div className="flex flex-wrap gap-2 mb-6">
                          <span className="px-3 py-1 bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 text-sm rounded-full font-medium">Neurology</span>
              ...
              {/* Specialties Grid */}
              <div className={`grid grid-cols-2 ${isMobile ? 'gap-3 mx-2' : 'lg:grid-cols-4 gap-4'}`}>
